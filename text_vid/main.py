...
def main():
    ...
    parser.add_argument("--bg-video", type=str,
                        required=True,
                        help='Path of the directory storing the background video files used for video rendering.')
    ...
    app = App(text_path, output_path, tmp_dir_path, font_path, bg_video_path, rate, volume, pitch)
